    ...
    render() {
        return (
            <Navbar bg="light" variant="light" expand="lg" sticky="top" className="details">
                <Navbar.Brand>
                    <Link to="/" style={{ color: 'lightseagreen', fontWeight: 'bold' }}><img className="imgLogo" src="./../../../../../wedding.svg" alt="main logo" /> Found IT</Link>
                </Navbar.Brand>
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="ml-auto">
                        ...
                        <Nav.Link as="span">
                            <NavLink to="/items/all" activeStyle={{ color: 'lightseagreen' }}>Find items</NavLink>
                        </Nav.Link>
                        ...
                        <Nav.Link as="span">
                            <NavLink to="/user" activeStyle={{ color: 'lightseagreen' }}>Hi, {this.props.loggedInUser ? this.props.loggedInUser.username : 'guest'}</NavLink>
                        </Nav.Link>
                    </Nav>
